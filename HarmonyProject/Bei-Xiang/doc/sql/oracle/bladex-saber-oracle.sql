...
INSERT INTO "BLADE_DATASOURCE" VALUES ('1161483504353484802', '1', 'postgresql', 'org.postgresql.Driver', 'jdbc:postgresql://127.0.0.1:5432/bladex', 'postgres', '123456', '', 'postgresql', '1123598821738675201', '1123598813738675201', TO_DATE('2020-08-08 12:20:02', 'SYYYY-MM-DD HH24:MI:SS'), '1123598821738675201', TO_DATE('2020-08-08 12:20:02', 'SYYYY-MM-DD HH24:MI:SS'), '1', '0');
...
CREATE TABLE "BLADE_OSS" (
  ...
  "TRANSFORM_ENDPOINT" NVARCHAR2(255) ,
...
-- Table PRIMARY KEY
-- ----------------------------
ALTER TABLE "BLADE_USER_WEB" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_USER_OTHER" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_USER_OAUTH" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_USER_DEPT" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_USER_APP" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_USER" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_TOP_MENU_SETTING" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_TOP_MENU" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_TENANT_PACKAGE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_TENANT" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_SMS" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_SCOPE_DATA" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_SCOPE_API" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_ROLE_SCOPE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_ROLE_MENU" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_ROLE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_REPORT_FILE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_REGION" ADD CONSTRAINT  PRIMARY KEY("CODE") ;

ALTER TABLE "BLADE_PROCESS_LEAVE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_POST" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_PARAM" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_OSS" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_NOTICE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_MODEL_PROTOTYPE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_MODEL" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_MENU" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_LOG_USUAL" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_LOG_ERROR" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_LOG_API" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_DICT_BIZ" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_DICT" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_DEPT" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_DATASOURCE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_CODE" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_CLIENT" ADD CONSTRAINT  PRIMARY KEY("ID") ;

ALTER TABLE "BLADE_ATTACH" ADD CONSTRAINT  PRIMARY KEY("ID") ;
