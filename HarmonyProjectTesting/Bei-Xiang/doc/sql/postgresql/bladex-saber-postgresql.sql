...
CREATE TABLE "blade_datasource" (
  ...
  "sharding_config" text COLLATE "pg_catalog"."default",
...
INSERT INTO "blade_datasource" VALUES (1161483504353484802, 1, 'postgresql', 'org.postgresql.Driver', 'jdbc:postgresql://127.0.0.1:5432/bladex', 'postgres', '123456', '', 'postgresql', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:02', 1123598821738675201, '2020-08-08 12:20:02', 1, 0);
INSERT INTO "blade_datasource" VALUES (1161483594023510018, 1, 'oracle', 'oracle.jdbc.OracleDriver', 'jdbc:oracle:thin:@127.0.0.1:1521:orcl', 'BLADEX', 'BLADEX', '', 'oracle', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:03', 1123598821738675201, '2020-08-08 12:20:03', 1, 0);
INSERT INTO "blade_datasource" VALUES (1161483594023510020, 1, 'sqlserver', 'com.microsoft.sqlserver.jdbc.SQLServerDriver', 'jdbc:sqlserver://127.0.0.1:1433;DatabaseName=bladex', 'bladex', 'bladex', '', 'sqlserver', 1123598821738675201, 1123598813738675201, '2020-08-08 12:20:03', 1123598821738675201, '2020-08-08 12:20:03', 1, 0);
COMMIT;
...
INSERT INTO "blade_dict" VALUES (1123598814738676229, 1123598814738676224, 'oss', '5', '华为云', 5, NULL, 0, 0);
INSERT INTO "blade_dict" VALUES (1123598814738676230, 1123598814738676224, 'oss', '6', 'amazon s3', 6, NULL, 0, 0);
...
INSERT INTO "blade_dict" VALUES (1735215689272508418, 0, 'datasource_category', '-1', '数据源类型', 16, NULL, 0, 0);
INSERT INTO "blade_dict" VALUES (1735215870613241857, 1735215689272508418, 'datasource_category', '1', 'jdbc', 1, NULL, 0, 0);
INSERT INTO "blade_dict" VALUES (1735215901546233858, 1735215689272508418, 'datasource_category', '2', 'sharding', 2, NULL, 0, 0);
COMMIT;
...
CREATE TABLE "blade_oss" (
  ...
  "transform_endpoint" varchar(255) COLLATE "pg_catalog"."default",
